    ...
    <section className="relative flex flex-col items-center justify-center text-center px-4 sm:px-0 py-24 space-y-10  rounded-3xl mt-20 shadow-2xl overflow-hidden border border-[#2d1a3a]/40 backdrop-blur-lg">
      <div className="mx-auto max-w-5xl space-y-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center z-10">
          <div className="relative group bg-gradient-to-br from-[#1e1932]/90 via-[#2d1a3a]/90 to-[#111827]/90 border border-[#C084FC]/30 rounded-3xl p-8 shadow-2xl w-96 backdrop-blur-lg overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-[0_8px_32px_0_rgba(192,132,252,0.25)] hover:border-[#C084FC]/60">
          ...
          <div className="relative group bg-gradient-to-bl from-[#1e1932]/90 via-[#2d1a3a]/90 to-[#111827]/90 border border-[#7C3AED]/30 rounded-3xl p-8 shadow-2xl w-96 backdrop-blur-lg overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-[0_8px_32px_0_rgba(124,58,237,0.25)] hover:border-[#7C3AED]/60">
