  ...
  return (
    <nav className="my-4 max-w-4xl mx-auto w-full z-50">
      <div className="flex items-center justify-between px-6 py-3">
        ...
        <div
          className="hidden md:flex justify-end items-center bg-transparent backdrop-blur-3xl pl-8 pr-3 py-3 rounded-xl space-x-8"
          style={{
        ...
        >
          {["Home", "Features", "Pricing", "About"].map((link) => (
            <a
              key={link}
              href="#"
              className="relative body_font text-white group"
            >
              {link}
